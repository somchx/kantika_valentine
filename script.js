    ...
    const memoryHTML = `
        <div class="memory-story-card">
            <div class="memory-story-content">
                ...
                <p class="story-paragraph">เค้าเชื่อมั่น
                ในความรักที่เธอมีให้เค้า</p>

                <p class="story-paragraph">และเค้าก็ค่อย ๆ เข้าใจ
                ว่าการถูกรัก
                จากคนที่รักจริง ๆ
                มันดีขนาดไหน</p>

                <p class="story-paragraph">มันทำให้เค้ารู้สึกอุ่นใจ
                รู้สึกมั่นคง
                และรู้สึกว่า
                เค้าอยากดูแลเธอให้ดีที่สุด</p>

                <p class="story-paragraph">เค้าไม่นิ่งนอนใจเลย
                ที่จะเตรียมการ
                ขอเธอเป็นแฟน</p>

                <p class="story-paragraph">ถึงจะยากเย็น
                ...
                <p class="story-paragraph">เพราะมันเป็นปีที่
                เราทั้งคู่ อายุ 25
                และจะ 25 ไปพร้อมกัน</p>

                <p class="story-paragraph">เป็นวันที่เราตั้งใจ
                จะเริ่มสร้างอนาคต
                ไปด้วยกันในปี 2025</p>

                <p class="story-paragraph">เลขสวยดีเนอะ
                แถมยังเป็น
                วันดีล้านนาอีกด้วย</p>

                <p class="story-paragraph">แต่วันที่เค้าขอเธอเป็นแฟน
                ก็เล่นเอาเค้า
                เจ็บแสบเหมือนกันนะคะ</p>

                <p class="story-paragraph">ฉลองสละโสด
                จนเมาแอ๋เลย
                น่าตีมากจริง ๆ 😅</p>

                <p class="story-paragraph">แต่ถึงยังไง
                เค้าก็รักเธออยู่ดี</p>

                <p class="story-paragraph">และรักมากขึ้นเรื่อย ๆ
                ในทุก ๆ วัน 🤍</p>
